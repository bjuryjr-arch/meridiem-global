    ...
    <div className="min-h-screen flex bg-[#f8f3e4]">
      ...
      <div className="hidden md:flex md:w-[44%] bg-[#091929] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute select-none" style={{
          ...
          <Image src="/meridiem-logo-transparent.png" alt="" fill className="object-contain" priority sizes="(max-width: 768px) 0px, 640px" />
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 bg-[#f8f3e4]">
        <div className="mx-auto w-full max-w-sm">
          ...
          {/* First-boot notice — no credentials displayed */}
          {isFirstBoot && (
            <div className="mb-6 rounded-lg border border-[#e2d9c8] bg-white p-4">
              <p className="text-xs font-semibold text-[#091929] mb-1.5 uppercase tracking-wide">Account Access</p>
              <p className="text-sm text-[#394452]">Contact your Meridiem account manager to receive your login credentials.</p>
            </div>
          )}
