/**
 * ⚠️  QUARANTINED COMPONENT — DO NOT USE IN PRODUCTION
 *
 * This component is UNUSED and does NOT transmit form submissions.
 * The handleSubmit handler only sets local React state — no data is ever
 * sent to Zoho Recruit, any CRM, or any backend endpoint.
 *
 * The live careers flow is handled by the Zoho Recruit external link on
 * the /careers page. Do not import this component into any public-facing
 * page or layout.
 */
